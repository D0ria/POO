...
public class KickDrum extends Acoustic {

	public KickDrum(int barecode, float price, String brand, String model, String state, float diameter,
	...
	public String toString() {
		return "Kick drum: " + toStringPercussion();
	}
