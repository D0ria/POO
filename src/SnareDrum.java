...
public class SnareDrum extends Acoustic {

	public SnareDrum(int barecode, float price, String brand, String model, String state, float diameter,
	...
	public String toString() {
		return "Snare drum: " + toStringPercussion();
	}
